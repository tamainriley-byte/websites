...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { path: "/massage-magaluf", priority: 0.8 },
    { path: "/massage-santa-ponsa", priority: 0.8 },
    { path: "/massage-palmanova", priority: 0.8 },
    { path: "/massage-paguera", priority: 0.8 },
    { path: "/massage-el-arenal", priority: 0.8 },
